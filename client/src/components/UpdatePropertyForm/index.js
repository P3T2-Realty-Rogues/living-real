          ...
          <div className="card-body">
            <div>
              ...
              <input
                ...
                type="text"
                placeholder={state.currentProperty.propertyName}
                name="propertyName"
              ></input>
            </div>
            <div>
              ...
              <input
                className="form-input"
                type="text"
                placeholder={state.currentProperty.propertyType}
                name="propertyType"
              ></input>
            </div>
            <div>
              ...
              <input
                className="form-input"
                type="text"
                placeholder={state.currentProperty.streetAddress}
                name="streetAddress"
              ></input>
            </div>
            <div>
              ...
              <input
                className="form-input"
                type="text"
                placeholder={state.currentProperty.city}
                name="city"
              ></input>
            </div>
            <div>
              ...
              <input
                className="form-input"
                type="text"
                placeholder={state.currentProperty.state}
                name="state"
              ></input>
            </div>
            <div>
              ...
              <input
                className="form-input"
                type="text"
                placeholder={state.currentProperty.zipCode}
                name="zipCode"
              ></input>
            </div>
            <div>
              ...
              <input
                className="form-input"
                type="text"
                placeholder={state.currentProperty.sqFeet}
                name="sqFeet"
              ></input>
            </div>
            <div>
              ...
              <input
                className="form-input"
                type="text"
                placeholder={state.currentProperty.numBedrooms}
                name="numBedrooms"
              ></input>
            </div>
            <div>
              ...
              <input
                className="form-input"
                type="text"
                placeholder={state.currentProperty.numBathrooms}
                name="numBathrooms"
              ></input>
            </div>
            <div>
              ...
              <input
                ...
                type="checkbox"
                name="balcony"
                checked={state.currentProperty.balcony}
              ></input>
            </div>
            <div>
              <label className="form-label" htmlFor="balcony">
              ...
              <input
                ...
                type="checkbox"
                name="balcony"
                checked={state.currentProperty.pool}
              ></input>
            </div>
            <div>
              ...
              <input
                className="form-input"
                type="text"
                placeholder={state.currentProperty.rent}
                name="rent"
              ></input>
            </div>
            <div>
              ...
              <input
                className="form-input"
                type="text"
                placeholder={state.currentProperty.rentDeposit}
                name="petDeposit"
              ></input>
            </div>
            <div>
              ...
              <input
                className="form-input"
                type="text"
                placeholder={state.currentProperty.renterDeposit}
                name="renterDeposit"
              ></input>
            </div>
            <div>
              ...
              <input
                className="form-input"
                type="text"
                placeholder={state.currentProperty.appFee}
                name="appFee"
              ></input>
            </div>
            <div>
        ...
        <div className="card">
          <div className="card-header">
            <h2 className="card-header">
              Admin Details for {state.currentProperty.propertyName}
            </h2>
          </div>
          <div className="card-body">
            <div>
              ...
              <input
                className="form-input"
                type="text"
                placeholder={state.currentProperty.ownerInfo.mortgage}
                name="mortgage"
              ></input>
            </div>
            <div>
              ...
              <input
                className="form-input"
                type="text"
                placeholder={state.currentProperty.ownerInfo.propertyTaxes}
                name="propertyTaxes"
              ></input>
            </div>
            <div>
              ...
              <input
                className="form-input"
                type="text"
                placeholder={state.currentProperty.ownerInfo.propertyInsurance}
