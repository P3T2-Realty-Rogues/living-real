        ...
        <div className="card-body">
          ...
          <div>
            ...
            <input
              className="form-input"
              type="text"
              placeholder={currentUser?.sqFeet}
              name="sqFeet"
            ></input>
          </div>
          <div>
            ...
            <input
              className="form-input"
              type="text"
              placeholder={currentUser?.numBedroom}
              name="numBedrooms"
            ></input>
          </div>
          <div>
            ...
            <input
              className="form-input"
              type="text"
              placeholder={currentUser?.numBathrooms}
              name="numBathrooms"
            ></input>
          </div>
          <div>
            ...
            <input
              ...
              type="text"
              name="balcony"
              placeholder={balconyPlaceHolder}
            ></input>
          </div>
          <div>
          ...
          <div>
            ...
            <input
              className="form-input"
              type="text"
              placeholder={currentUser?.petDeposit}
              name="petDeposit"
            ></input>
          </div>
          <div>
            ...
            <input
              className="form-input"
              type="text"
              placeholder={currentUser?.renterDeposit}
              name="renterDeposit"
            ></input>
          </div>
          <div>
            ...
            <input
              className="form-input"
              type="text"
              placeholder={currentUser?.appFee}
              name="appFee"
            ></input>
          </div>
          <div>
